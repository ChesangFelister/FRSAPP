...
import { LayoutDashboard, Building2, Users, LogOut, Menu, Wallet, CalendarClock, HardHat, Receipt, Settings as SettingsIcon, Wrench, Zap, Droplets, Trash2, Package, ShoppingCart } from "lucide-react";
...
const nav = [
  ...
  { to: "/landlord/power", label: "Power", icon: Zap },
  { to: "/landlord/water", label: "Water", icon: Droplets },
  { to: "/landlord/waste", label: "Waste", icon: Trash2 },
  { to: "/landlord/inventory", label: "Inventory", icon: Package },
  { to: "/landlord/procurement", label: "Procurement", icon: ShoppingCart },
